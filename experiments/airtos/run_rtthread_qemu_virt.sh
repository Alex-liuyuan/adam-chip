...
out=$(realpath -m "${1:?usage: run_rtthread_qemu_virt.sh OUT_DIR [PLATFORM [TARGET_INCLUDE]]}")
platform=$(realpath "${2:-${AIRTOS_RTTHREAD_PLATFORM:-$root/build/phase_reports/phase10-final/integration/generated/platform}}")
